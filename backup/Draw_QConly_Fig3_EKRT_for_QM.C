...
void Draw_QConly_Fig3_EKRT_for_QM(){
	...
	leg3->AddEntry((TObject*)NULL,"|#eta| < 0.8 , 0.2 < p_{T} < 5.0 GeV/c","");
	...
	line_0_60->Draw("same l");
	TLegend *leg4 = new TLegend( 0.15, 0.65, 0.81, 0.86, "ALICE Preliminary Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV", "brNDC");
	leg4->AddEntry((TObject*)NULL,"|#eta| < 0.8 , 0.2 < p_{T} < 5.0 GeV/c","");
	leg4->SetTextSize(0.054);
	...
	if(Draw_TLatex==kTRUE) latex.DrawLatexNDC( 0.93, 0.93 , "(a)");
	line_0_60->Draw("same l");
	TLegend *leg5 = new TLegend( 0.2, 0.7, 0.72, 0.92, "ALICE Preliminary Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV", "brNDC");
	leg5->AddEntry((TObject*)NULL,"|#eta| < 0.8 , 0.2 < p_{T} < 5.0 GeV/c","");
	...
	if(Draw_TLatex==kTRUE) latex.DrawLatexNDC( 0.93, 0.93 , "(b)");
	line_0_60->Draw("same l");
	TLegend *leg6 = new TLegend( 0.15, 0.7, 0.7, 0.9, "ALICE Preliminary Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV", "brNDC");
	leg6->AddEntry((TObject*)NULL,"|#eta| < 0.8 , 0.2 < p_{T} < 5.0 GeV/c","");
	...
	line_0_60->Draw("same l");
	TLegend *leg7 = new TLegend( 0.15, 0.1, 0.76, 0.3, "ALICE Preliminary Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV", "brNDC");
	leg7->AddEntry((TObject*)NULL,"|#eta| < 0.8 , 0.2 < p_{T} < 5.0 GeV/c","");
	...
	TLegend *legmult = new TLegend( 0.48, 0.69, 0.88, 0.96, NULL, "brNDC");
	legmult->AddEntry((TObject*)NULL,"ALICE Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV","");
	legmult->AddEntry((TObject*)NULL,"|#eta| < 0.8, 0.2 < p_{T} < 5.0 GeV/c","");
	legmult->SetTextSize(0.078);
	legmult->SetBorderSize(0);
	legmult->SetFillStyle(0);

	TLegend *legEKRT = new TLegend( 0.18, 0.10, 0.5, 0.4, "EKRT+Viscous Hydrodynamics", "brNDC");
	legEKRT->SetTextSize(0.078);
	legEKRT->SetBorderSize(0);
	legEKRT->SetFillStyle(0);
	legEKRT->AddEntry( gr_SC_EKRT[0][0], "param0 (#eta/s=0.2)", "l");
	legEKRT->AddEntry( gr_SC_EKRT[1][1], "param1 (#eta/s(T))", "l");
	...
	c100->SaveAs("figs/ModelComparison_All_EKRT.eps");
