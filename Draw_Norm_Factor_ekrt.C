...
bool Draw_old_ekrt[kNSC] = { 1, 1, 0, 0, 0 }; // old ekrt have only SC32, SC42
...
void Draw_Norm_Factor_ekrt(){
				...
				int isc=0;
								...
								upPad->cd();
								TLegend *leg = new TLegend( 0.12, 0.6, 0.6, 0.93, "#LTv_{3}^{2}#GT#LTv_{2}^{2}#GT", "brNDC");
								leg->SetBorderSize(0);
								leg->SetFillStyle(0);
...
//									CalculateRatio(gr_C_factor_AMPT[isc][iampt], gr_C_factor[isc], 0)->Draw("same pl");
				...
				y_max = 5e-6;
								...
								upPad2->cd();
								TLegend *leg2 = new TLegend( 0.12, 0.55, 0.62, 0.93, "#LTv_{4}^{2}#GT#LTv_{2}^{2}#GT", "brNDC");
...
//									CalculateRatio(gr_C_factor_EKRT[isc][ipar], gr_C_factor[isc], 0)->Draw("same pl");
				...
				y_max = 0.8e-6;
								...
								upPad3->cd();
								TLegend *leg3 = new TLegend( 0.12, 0.66, 0.7, 0.93, "#LTv_{5}^{2}#GT#LTv_{2}^{2}#GT", "brNDC");
...
//									CalculateRatio(gr_C_factor_AMPT[isc][iampt], gr_C_factor[isc], 0)->Draw("same pl");
				...
				y_max = 0.08e-6;
								...
								upPad4->cd();
								TLegend *leg4 = new TLegend( 0.12, 0.66, 0.7, 0.93, "#LTv_{5}^{2}#GT#LTv_{3}^{2}#GT", "brNDC");
...
//									CalculateRatio(gr_C_factor_AMPT[isc][iampt], gr_C_factor[isc], 0)->Draw("same pl");
	...
	if(1){
				...
				y_max = 0.5e-6;
								...
								upPad5->cd();
								TLegend *leg5 = new TLegend( 0.12, 0.66, 0.7, 0.93, "#LTv_{4}^{2}#GT#LTv_{3}^{2}#GT", "brNDC");
...
//									gr_C_factor_AMPT[isc][iampt]->Draw("same pl");
								...
								for(int ipar=0; ipar<2; ipar++){
									CalculateRatio(gr_C_factor_EKRT[isc][ipar], gr_C_factor[isc], 0)->Draw("same pl");
									CalculateRatio(gr_C_factor_EKRT[isc][ipar], gr_C_factor[isc], 0)->Print();
								}	
								for(int iampt=0; iampt<3; iampt++){
//									CalculateRatio(gr_C_factor_AMPT[isc][iampt], gr_C_factor[isc], 0)->Draw("same pl");
								}
