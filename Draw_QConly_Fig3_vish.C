...
//===================================================================================
	...
	TLegend *leg3 = new TLegend( 0.15, 0.06, 0.81, 0.66, "#splitline{ALICE Preliminary}{ Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV}", "brNDC");
...
//	TH2D *href3_low = new TH2D( "href3_low", "", 100, x_min, x_max, 100, -0.6, 0.3);
	...
	href3_low->Draw();
	TLegend *leg3_low = new TLegend( 0.65, 0.83, 0.98, 0.88, "", "brNDC");
...
//===================================================================================
	...
	c4->Draw();
	c4->cd(1);
	TH2D *href4 = new TH2D( "href4", "", 100, x_min, x_max, 100, -4.2e-7, 40.6e-7);
	href4->SetStats(0);
	...
	line_0_60->Draw("same l");
	TLegend *leg4 = new TLegend( 0.2, 0.75, 0.81, 0.9, "ALICE Preliminary Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV", "brNDC");
...
//===================================================================================
	...
	c5->Draw();
	c5->cd(1);
	TH2D *href5 = new TH2D( "href5", "", 100, x_min, x_max, 100, -0.2e-7, 3.45e-7);
	href5->SetStats(0);
	...
	if(Draw_TLatex==kTRUE) latex.DrawLatexNDC( 0.93, 0.93 , "(a)");
	line_0_60->Draw("same l");
	TLegend *leg5 = new TLegend( 0.15, 0.75, 0.72, 0.87, "ALICE Preliminary Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV", "brNDC");
	leg5->SetTextSize(0.047);
...
//===================================================================================
	...
	c6->Draw();
	c6->cd(1);
	TH2D *href6 = new TH2D( "href6", "", 100, x_min, x_max, 100, -0.13e-7, 1.59e-7);
	href6->SetStats(0);
	...
	if(Draw_TLatex==kTRUE) latex.DrawLatexNDC( 0.93, 0.93 , "(b)");
	line_0_60->Draw("same l");
	TLegend *leg6 = new TLegend( 0.12, 0.7, 0.75, 0.87, "ALICE Preliminary Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV", "brNDC");
	leg6->SetTextSize(0.047);
...
//	TH2D *href6_low = new TH2D( "href5_low", "", 100, x_min, x_max, 100, -0.08, 3.35);
	...
	href6_low->Draw();
	TLegend *leg6_low = new TLegend( 0.15, 0.61, 0.63, 0.94, "", "brNDC");
...
//===================================================================================
	...
	line_0_60->Draw("same l");
	TLegend *leg7 = new TLegend( 0.15, 0.07, 0.81, 0.65, "#splitline{ALICE Preliminary}{ Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV}", "brNDC");
