	...
	TString datainfo[NData][3] = { // rootfile name , gr name, legend 
		"../results_0720/results_AMPT13f3a_JFFluc_KineOnly_Eta0408_Pt0250.root", 
			"gr_SC_norm_with_QC_3223", "SC(3,2)",
		"../results_0720/results_AMPT13f3a_JFFluc_KineOnly_Eta0408_Pt0250.root", 
			"gr_SC_norm_with_QC_4224", "SC(4,2)",
		"../results_0720/results_AMPT13f3a_JFFluc_KineOnly_Eta0408_Pt0250.root", 
			"gr_SC_norm_with_QC_5225", "SC(5,2)",
		"../results_0720/results_AMPT13f3a_JFFluc_KineOnly_Eta0408_Pt0250.root", 
			"gr_SC_norm_with_QC_5335", "SC(5,3)",
		"../results_0720/results_AMPT13f3a_JFFluc_KineOnly_Eta0408_Pt0250.root", 
			"gr_SC_norm_with_QC_4334", "SC(4,3)"
	};
	...
	TString strLeg = "AMPT, Sting melting w/o hadronic rescattering";
...
void NSC_AMPT_STON_RCOFF(){
	...
	leg->Draw();
	c1->SaveAs("NSC_AMPT_STON_RSOFF.eps");
}
