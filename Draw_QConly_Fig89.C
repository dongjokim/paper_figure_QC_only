...
static void hset(TH1& hid, TString xtit="", TString ytit="",
...
//				gr_SC[im][ipt][isc]->Print();
	...
	gPad->GetCanvas()->SaveAs("figs/Fig8_pt_NSC32_Models.eps");
	...
	gPad->GetCanvas()->SaveAs("figs/Fig9_pt_NSC42_Models.eps");
