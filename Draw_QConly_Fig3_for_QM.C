...
//===================================================================================
	...
	TLegend *leg3 = new TLegend( 0.125, 0.12, 0.94, 0.43, "ALICE Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV", "brNDC");
	...
	href3_low->Draw();
	TLegend *leg3_low = new TLegend( 0.15, 0.7, 0.72, 0.92, "", "brNDC");
...
//	TGaxis::SetExponentOffset(0.01644, -0.0844, "y");
	...
	line_0_60->Draw("same l");
	TLegend *leg4 = new TLegend( 0.125, 0.62, 0.9, 0.88, "ALICE Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV", "brNDC");
	leg4->SetTextSize(LegTxtSize+0.00);
	...
	href4_low->Draw();
	TLegend *leg4_low = new TLegend( 0.15, 0.72, 0.6, 0.92, "", "brNDC");
...
//	TGaxis::SetExponentOffset(0.01644, -0.0844, "y");
	...
	if(Draw_TLatex==kTRUE) latex.DrawLatexNDC(0.91, 0.91, "(a)");
	line_0_60->Draw("same l");
	TLegend *leg5 = new TLegend( 0.125, 0.65, 0.81, 0.92, "ALICE Preliminary Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV", "brNDC");
	leg5->SetTextSize(LegTxtSize+0.00);
	...
	href5_low->Draw();
	TLegend *leg5_low = new TLegend( 0.15, 0.72, 0.6, 0.95, "", "brNDC");
...
//===================================================================================
	...
	c6->Draw();
	c6->cd(1);
	TH2D *href6 = new TH2D( "href6", "", 100, x_min, x_max, 100, -0.03e-7, 0.73e-7);
	href6->SetStats(0);
...
//	TGaxis::SetExponentOffset(0.01644, -0.0844, "y");
	...
	if(Draw_TLatex==kTRUE) latex.DrawLatexNDC(0.91, 0.91, "(b)");
	line_0_60->Draw("same l");
	TLegend *leg6 = new TLegend( 0.125, 0.67, 0.81, 0.9, "ALICE Preliminary Pb-Pb #sqrt{#it{s}}_{NN} = 2.76 TeV", "brNDC");
	leg6->SetTextSize(LegTxtSize+0.00);
	...
	href6_low->Draw();
	TLegend *leg6_low = new TLegend( 0.15, 0.72, 0.63, 0.96, "", "brNDC");
...
//	TGaxis::SetExponentOffset(0.01644, -0.0844, "y");
	...
	href7_low->Draw();
	TLegend *leg7_low = new TLegend( 0.15, 0.75, 0.6, 0.93, "", "brNDC");
